...
namespace organProject.Migrations
{
    ...
    [Migration("20200825202334_firstMigration")]
            ...
            modelBuilder.Entity("organProject.Models.Donor", b =>
                {
                    ...
                    b.Property<string>("CurrentCenterCenterName")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
                    ...
                    b.HasIndex("CurrentCenterCenterName");
            ...
            modelBuilder.Entity("organProject.Models.Donor", b =>
                {
                    b.HasOne("organProject.Models.Center", "CurrentCenter")
                        .WithMany()
                        .HasForeignKey("CurrentCenterCenterName");
                });
